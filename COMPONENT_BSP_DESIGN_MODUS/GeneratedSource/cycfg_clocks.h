...
#define CLK_PD_ISNK_ENABLED 1U
#define CLK_PD_ISNK_HW CY_SYSCLK_DIV_16_BIT
#define CLK_PD_ISNK_NUM 0U
...
#define CLK_REFGEN_ENABLED 1U
#define CLK_REFGEN_HW CY_SYSCLK_DIV_8_BIT
#define CLK_REFGEN_NUM 3U

#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t CLK_PD_ISNK_obj;
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t CLK_REFGEN_obj;
#endif //defined (CY_USING_HAL)
