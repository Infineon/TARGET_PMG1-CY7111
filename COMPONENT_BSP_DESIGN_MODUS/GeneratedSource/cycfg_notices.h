...
#ifndef CYPM1111_40LQXIT
    #error "Unexpected target MCU; expected CYPM1111-40LQXIT. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
