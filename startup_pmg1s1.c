...
extern const cy_israddress __VECTOR_TABLE[CY_VECTOR_TABLE_SIZE];
    ...
    ioss_interrupts_gpio_4_IRQHandler,        /*   4 GPIO P4 */
    ioss_interrupts_gpio_5_IRQHandler,        /*   5 GPIO P5 */
    ioss_interrupt_gpio_IRQHandler,           /*   6 GPIO All ports */
    usbpd_0_interrupt_wakeup_IRQHandler,      /*   7 Ganged USBPD Interrupt */
    srss_interrupt_wdt_IRQHandler,            /*   8 WDT or Temp (WDT only in DeepSleep) */
    scb_0_interrupt_IRQHandler,               /*   9 SCB[0] */
    scb_1_interrupt_IRQHandler,               /*  10 SCB[1] */
    scb_2_interrupt_IRQHandler,               /*  11 SCB[2] */
    scb_3_interrupt_IRQHandler,               /*  12 SCB[3] */
    cpuss_interrupt_spcif_IRQHandler,         /*  13 SPC */
    usbpd_0_interrupt_IRQHandler,             /*  14 Synchronous USBPD Interrupts */
    tcpwm_interrupts_0_IRQHandler,            /*  15 TCPWM counter #0 */
    tcpwm_interrupts_1_IRQHandler,            /*  16 TCPWM counter #1 */
    crypto_interrupt_IRQHandler               /*  17 Crypto block */
};
